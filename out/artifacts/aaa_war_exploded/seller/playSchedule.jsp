...
<head>
    ...
    <%--<link rel="stylesheet" type="text/css" href="/static/css/schdule.css">--%>
...
<!--所有的演出计划-->
<div id="table">
    <table class="table table-striped table-hover" id = 'schedule' >
        <caption style="text-align: center">查看演出计划</caption>
        <tr class="warning">
            <td>演出计划ID</td>
            <td>演出厅</td>
            <td>剧目名称</td>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form" id="change" >
                    演出计划id:<input type="text" name = "sched_id" class="form-control" id = "change_id"   ><br>
